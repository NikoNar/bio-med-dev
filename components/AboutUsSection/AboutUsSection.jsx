...
const AboutUsSection = ({aboutUs}) => {
    ...
    return (
        <section className={AUStyle.About} style={{ backgroundImage: `url(${aboutUs[0].metadata.image ? aboutUs[0].metadata.image : aboutUs[0]._embedded['wp:featuredmedia'][0].source_url})` }}>
